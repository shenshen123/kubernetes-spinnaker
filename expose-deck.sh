...
nohup kubectl --namespace spinnaker port-forward $(kubectl --namespace spinnaker get pods -l replication-controller=skrdemo-dev-v000 -o jsonpath='{.items[*].metadata.name}') 8000:8000 &
